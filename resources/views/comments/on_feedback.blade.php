@extends('layouts.app', ['title' => 'Tanggapan Saya Terhadap Masukan'])
@section('content')
<br>
@component('content', ['judul' => 'Tanggapan Saya Terhadap Masukan'])
<div class="card">
	<div class="card-body">
		...
		<tbody>
			...
			<tr>
				...
				<td><a href="{{ $c->post->link }}">{{ $c->post->title }}</a></td>
				<td>{{ $c->dibuat_pada }}</td>
				<td>
					@if($c->status === '1')
